...
public class FacebookManager {
	...
	private static final String REDIRECT_URI = "/login/sns/facebook.do";
	...
	public String getAccessToken(HttpServletRequest request) {
		...
		String facebookUse = snsProp.getProperty("sns.facebook.use");
		
		//SNS 사용중이 아니면 false
		if(!StringUtil.isEqual(snsUse, "Y") || !StringUtil.isEqual(facebookUse, "Y")) {
			return null;
		}

		//KAKAO API키
		String apiKey = snsProp.getProperty("sns.facebook.apiKey");
		...
		try {
			...
			String apiURL = "https://kauth.facebook.com/oauth/token";
	...
	public UserVO getUserInfo(String accessToken) {
		...
		try {
	        ...
	        String apiURL = "https://kapi.facebook.com/v2/user/me";
            url = new URL(apiURL);
            ...
            if(responseCode==200) {
				...
				if(userMap != null) {
					String userId = "facebook@" + userMap.get("id");
					user = new UserVO();
