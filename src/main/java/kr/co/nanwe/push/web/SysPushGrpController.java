...
/**
 * @Class Name 		: SysPushGrpController
 * @Description 	: 
...
@RequestMapping(value = "/sys/push/grp")
@Program(code="PUSH_GRP", name="앱사용자 그룹관리")
@Controller
public class SysPushGrpController {
	
	//private static final Logger LOGGER = LoggerFactory.getLogger(SysPushGrpController.class);
	
	/** View Path */
	private static final String VIEW_PATH = "sys/push/grp";
	...
	/** Constructor */
	public SysPushGrpController() {		
		RequestMapping requestMapping = SysPushGrpController.class.getAnnotation(RequestMapping.class);
	...
	public String list(Model model, HttpServletRequest request, @ModelAttribute SearchVO search){
		...
		//목록조회
		Map<String, Object> map = pushGrpService.selectPushGrpMstList(search);
	...
	public String view(Model model, HttpServletRequest request, @ModelAttribute SearchVO search
		...
		//상세조회
		PushGrpMstVO pushGrpMstVO = pushGrpService.selectPushGrpMst(grpCd);
	...
	public String modifyView(Model model, HttpServletRequest request, @ModelAttribute SearchVO search
		...
		//상세조회
		PushGrpMstVO pushGrpMstVO = pushGrpService.selectPushGrpMst(id);
	...
	public String removeAction(Model model, HttpServletRequest request, @ModelAttribute SearchVO search
		...
		int result = 0;
		if (EgovDoubleSubmitHelper.checkAndSaveToken()) {
			result = pushGrpService.deletePushGrpMst(id);
		}
	...
	public String checkRemoveAction(Model model, HttpServletRequest request, @ModelAttribute SearchVO search
		...
		//삭제처리
		int result = pushGrpService.deleteCheckedPushGrpMst(checkedSId);
