	...
	<div id="main_container">
		...
		<div class="rightmain_wrap">			
			<div class="board_wrap">
				...
				<div class="notice_area">
    					...
    					<c:forEach var="result" items="${notiList}" varStatus="status">
        					<li>
                                <div class="notice_lefttext">
            					    <a href="/cop/bbs/selectBoardList.do?bbsId=BBSMSTR_AAAAAAAAAAAA&menuNo=43">    
    				...
    				<div class="notice_area">
    					...
    					<a href="/cop/bbs/selectBoardList.do?bbsId=BBSMSTR_BBBBBBBBBBBB&menuNo=43" class="more"><img src="<c:url value='/images/index/btn_more.gif' />" alt="more" /></a>
    					<ul>
    						<c:forEach var="result" items="${galList}" varStatus="status">
                                <li>
                                    <div class="notice_lefttext">
                                        <a href="/cop/bbs/selectBoardList.do?bbsId=BBSMSTR_BBBBBBBBBBBB&menuNo=43">
                                            <c:if test="${result.replyLc!=0}">
                                                <c:forEach begin="0" end="${result.replyLc}" step="1">&nbsp;</c:forEach>
                                                <img src="<c:url value='/images/reply_arrow.gif'/>" alt="reply arrow"/>
                                            </c:if>
				...
				<div class="info_divwrap"> 
					<div class="righttop_banner"> 
						<ul>							
							<li><a href="/EgovPageLink.do?menuNo=21&linkIndex=13"><img src="<c:url value='/images/index/img_product.gif' />" alt="주요사업 소개" title="샘플화면으로 이동합니다.(주요사업 소개)" /></a></li>
							<li><a href="/EgovPageLink.do?menuNo=22&linkIndex=14"><img src="<c:url value='/images/index/img_service.gif' />" alt="대표서비스 소개" title="샘플화면으로 이동합니다.(대표서비스 소개)" /></a></li>
						</ul>
					</div>
					<div class="middle_banner" style="">
						<ul>
							<li class="li_btm"><a href="/EgovPageLink.do?menuNo=31&linkIndex=15"><img src="<c:url value='/images/index/img_download.gif' />" alt="자료실:다양한자료를 다운로드 받으실 수 있습니다." title="샘플화면으로 이동합니다.(자료실)" /></a></li>
							<li><a href="/EgovPageLink.do?menuNo=14&linkIndex=12"><img src="<c:url value='/images/index/img_location.gif' />" alt="표준프레임워크센터:찾아오시는 길" title="샘플화면으로 이동합니다.(찾아오시는길)" /></a></li>
						</ul>
					</div>
				</div>
			</div>
			...
			<div id="main_btm_area">
				<ul>
					<li><a href="/EgovPageLink.do?menuNo=33&linkIndex=17">
					...
					<li><div class="img_div01">
					    <a href="/cop/smt/sim/EgovIndvdlSchdulManageWeekList.do?menuNo=42"><img src="<c:url value='/images/index/img_schedule.gif' />" alt="일정 현황" /></a></div>
					</li>
