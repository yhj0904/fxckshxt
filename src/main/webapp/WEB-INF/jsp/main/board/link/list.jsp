				...
				<td class="subj">
					<div class="tit" data-depth="<c:out value="${item.bbsDepth }"/>">
						...
						<c:choose>
							...
							<c:otherwise>
								<c:choose>
									<c:when test='${!empty item.bbsInfo01 }'>
										<c:choose>
											<c:when test='${fn:contains(item.bbsInfo01,"http")}'>
												<a target="_blank" href="<c:out value="${item.bbsInfo01} "/>">
											</c:when>
											<c:otherwise>
												<a target="_blank" href="https://<c:out value="${item.bbsInfo01} "/>">
											</c:otherwise>
										</c:choose>
									</c:when>
									<c:otherwise>
