...
<div class="board_wrap">
	...
	<script type="text/javaScript" defer="defer">
		//패스워드체크
		function fn_chkPw(url, sId) {
			gf_confirmPwChk("<input id='pw' type='password' value='' placeholder='비밀번호를 입력하세요.'/>", () => {
				var data = {
					pw: $('#pw').val(),
					boardId: sId,
				}
				gf_ajax({
					...
					if (rs == "SUCCESS") {
						...
						gf_alert("비밀번호가 일치하지 않거나, 권한이 없습니다.")
					}
				});
			});
		}
		...
		//상세보기
		function fn_detailView(sId, sCate) {
			document.listForm.sId.value = "";
