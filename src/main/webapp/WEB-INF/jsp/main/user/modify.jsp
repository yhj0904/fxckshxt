...
<form:form modelAttribute
	...
	<table class="detail_table mypage_table">
		...
		<tr>
			...
			<td>
				<form:password path="password" cssClass="w_full" placeholder="비밀번호는 특수문자, 숫자, 영문을 포함 8자 이상으로 입력해주세요" />
		...
		<tr>
			...
			<td>
				<form:password path="passwordCheck" cssClass="w_full" placeholder="입력하신 비밀번호를 다시 한번 입력해주세요"/>
		...
		<tr>
			<th><label for="sex"><spring:message code="userVO.sex" /></label></th>
			<td>
		...
		<tr>
			<th><label for="userTypeCd"><spring:message code="userVO.userTypeCd" /></label></th>
			<td>
		...
		<tr class="mr-info">
			<th><label for="userTypeDetCd"><spring:message code="userVO.userTypeDetCd" /></label></th>
			<td>
		...
		<tr class="mr-info">
			<th><label for="colgCd"><spring:message code="userVO.colgCd" /></label></th>
			<td>
				<ul class="colg-list">
					<li class="">
						<input type="text" id="hiColgNm" name="hiColgNm" value="${userVO.colgNm }" readonly />
					</li>
					<li class="search-sec">
		...
		<tr class="mr-info">
			<th><label for="stdNo"><spring:message code="userVO.stdNo" />/<spring:message code="userVO.grade" /></label></th>
			<td>
	...
	<div class="user_dept_cd_view"></div>	
...
<script type="text/javaScript" defer="defer">
	...
	function fn_detailView() {
		document.detailForm.action = GV_PRESENT_PATH + "/mypage.do";
	...
	function fn_addColgCd(){
			gf_ajax({
				...
				$(".user_dept_cd_view").remove("#DEPT-POP");
