...
<form:form commandName="progVO" id="detailForm" name="detailForm" method="post" autocomplete="off" enctype="multipart/form-data">
	
	<form:hidden path="semstrCd"/>
	<form:hidden path="statusCd" value='PROG_STATUS_010'/>
			...
			<colgroup>
	   		...
	   		<tbody>
	   			<tr>
	   				...
	   				<td colspan="3"><form:input path="progNm" cssClass="w_full" /> <span class="form_error" data-path="progNm"><form:errors path="progNm" /></span></td>
	   			</tr>
	   			<tr>
	   			...
	   			<tr>
					...
					<th><label for="reqstNmpr"><spring:message code="progVO.reqstNmpr" /></label></th>
	   				<td>
						<input type="number" id="reqstNmpr" name="reqstNmpr" />
				...
				<tr class="mr-info mr-info03">
	   			...
	   			<tr>
	   				...
	   				<td>
						<form:input path="progStm" cssClass="input_time" />
					...
					<th><label for="progEtm"><spring:message code="progVO.progEtm" /></label></th>
	   				<td>
						<form:input path="progEtm" cssClass="input_time"/>
			...
			<colgroup>
	   		...
	   		<tbody>
	   			<tr>
	   				...
	   				<td>
						<form:input path="eduOrgNm" value="대학일자리플러스센터"/>	
	   			...
	   			<tr>
	   				...
	   				<td>
						<form:input path="eduTelNo" value="063-850-5782"/>	
					...
					<th><label for="eduEmail"><spring:message code="progVO.eduEmail" /></label></th>
	   				<td>
						<form:input path="eduEmail" value="bon5781@wku.ac.kr"/>	
