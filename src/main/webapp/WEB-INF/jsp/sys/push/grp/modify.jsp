 ...
 */
%>
<form:form modelAttribute="pushGrpMstVO" id="detailForm" name="detailForm" method="post" autocomplete="off" enctype="multipart/form-data">
	<div class="grid_wrap">
		<div class="col50">
			<div class="col_title">
				<p>그룹정보</p>
			...
			<div class="col_inner">
				<table class="detail_table">
					...
					<tr>
						<th><label for="grpCd"><spring:message code="pushGrpMstVO.grpCd"/></label></th>
						<td>
							<c:out value='${pushGrpMstVO.grpCd }'/>
							<form:hidden path="grpCd"/>
							<span class="form_error" data-path="grpCd"><form:errors path="grpCd"/></span>
						</td>
					</tr>
					<tr>
						<th><label for="grpCreUser"><spring:message code="pushGrpMstVO.grpCreUser"/></label></th>
						<td>
							<c:out value='${pushGrpMstVO.grpCreUser }'/>
							<form:hidden path="grpCreUser"/>
							<span class="form_error" data-path="grpCreUser"><form:errors path="grpCreUser"/></span>
						</td>
					</tr>
					<tr>
					...
					<tr>
						<th><label for="grpPer"><spring:message code="pushGrpMstVO.grpPer"/></label></th>
						<td>
							<form:input path="grpPer"/>
							<span class="form_error" data-path="grpPer"><form:errors path="grpPer"/></span>
						</td>
					</tr>
					<tr>
