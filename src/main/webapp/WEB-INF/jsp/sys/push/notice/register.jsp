 ...
 */
%>
<form:form commandName="pushNoticeVO" id="detailForm" name="detailForm" method="post" autocomplete="off" enctype="multipart/form-data">
	<div class="grid_wrap">
		<div class="col50">
			<div class="col_title">
				<p>알림내용</p>
			...
			<div class="col_inner">
				<table class="detail_table">
					<caption>알림관리 등록</caption>
					<colgroup>
			   			<col width="150"/>
			   			<col width="?"/>
			   		</colgroup>
					<tr>
						<th><label for="noticeTitle"><spring:message code="pushNoticeVO.noticeTitle"/></label></th>
						<td>
					...
					<tr>
						<th><label for="noticeData"><spring:message code="pushNoticeVO.noticeData"/></label></th>
						<td>
							<label class="textarea">
								<form:textarea path="noticeData" onkeyup="fn_checkByte(this);"/>
								<span class="count" id="noticeDataCnt">0/2000</span>
							</label>
							<span class="form_error" data-path="noticeData"><form:errors path="noticeData"/></span>
						</td>
					</tr>
					<tr>
						<th><label for="noticeImg"><spring:message code="pushNoticeVO.noticeImg"/></label></th>
						<td>
		    				<label class="file">
					...
					<tr>
						<th><label for="reservationDt"><spring:message code="pushNoticeVO.reservationDt"/></label></th>
						<td>
					...
					<tr>
						<th><label for="userId"><spring:message code="pushNoticeVO.userId"/></label></th>
						<td>
		...
		<div class="col50">
			...
			<div class="col_inner">
				<span class="board_total_count"><spring:message code="board.total"/> <b id="sendUserCnt"><c:out value='${fn:length(pushNoticeVO.sendList)} '/></b><spring:message code="board.row"/></span>
				...
				<div class="btn_wrap">
					<ul>
						<li>
							<a class="button save_btn" href="javascript:fn_searchPop();">발송대상자 등록</a>
						</li>
						<li>
...
<script type="text/javaScript" defer="defer">
	...
	function fn_checkByte(obj) {
		gf_checkByte(obj, 2000, $("#noticeDataCnt"));
	}
