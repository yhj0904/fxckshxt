		...
		<li>
			...
			<div class="sub_cont">
				<div style="text-align:right;">
					<a class="button" href="javascript:fn_getUserList();"><spring:message code='survTrgtVO.message.addId'/></a>
					<a class="button" href="javascript:fn_getAuthList();"><spring:message code='survTrgtVO.message.addCd'/></a>
				</div>
					...
					<tbody id="trgtList">
						<c:forEach var="trgt" items="${survMgtVO.trgtList }" varStatus="t">
							...
							<tr>
								...
								<td>
									<c:choose>
										<c:when test='${trgt.trgtType eq "TRGT_CD"}'>
											<c:out value='${trgt.trgtCd }'/>
											<input type="hidden" name="trgtCd" value="<c:out value='${trgt.trgtCd }'/>"/>
										</c:when>
										<c:when test='${trgt.trgtType eq "TRGT_ID"}'>
											<c:out value='${trgt.trgtId }'/>
											<input type="hidden" name="trgtId" value="<c:out value='${trgt.trgtId }'/>"/>
										</c:when>
									</c:choose>
								</td>
								<td><a class="button removeTrgtBtn" href="#none"><spring:message code='button.remove'/></a></td>
							</tr>
						</c:forEach>
					</tbody>
			  	</table>
