		...
		<li>
			<div class="sub_cont">
				<table class="detail_table">
					...
					<tr>
						<th><spring:message code="survMgtVO.totalPoint"/></th>
						<td><c:out value="${survMgtVO.totalPoint}"/></td>
					</tr>
					<tr>
						<th><spring:message code="survMgtVO.totalCount"/></th>
						<td><c:out value="${survMgtVO.totalCount}"/></td>
					</tr>
			  	</table>
			</div>
		</li>
					...
					<tbody id="trgtList">
						<c:forEach var="user" items="${userList }" varStatus="i">
							<tr>
								...
								<td><a href="javascript:fn_resultUserView('<c:out value='${survMgtVO.survId }'/>','<c:out value='${user.inptId }'/>')"><spring:message code="survMgtVO.button.userResult"/></a></td>
							</tr>
						</c:forEach>
					</tbody>
			  	</table>
...
<script type="text/javaScript" defer="defer">
	...
	$(document).on("click", ".etcViewBtn", function(){
		...
		if(obj.next().css("display") == "none"){			
			if(viewYn == "N"){
				gf_ajax({
					url : "/sys/surv/etcView.do",
					type : "POST",
					data : { survId : '<c:out value="${survMgtVO.survId}"/>', quesIdx : quesIdx, itemIdx : itemIdx },
	...
	//목록
	function fn_resultUserView(survId, userId) {
